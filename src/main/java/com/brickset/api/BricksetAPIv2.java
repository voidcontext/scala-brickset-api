 ...
 * 2015-03-28T18:10:42.259-04:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "BricksetAPIv2", 
                  wsdlLocation = "file:src/main/resources/brickset-api-v2.wsdl",
...
public class BricksetAPIv2 extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/brickset-api-v2.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BricksetAPIv2.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/brickset-api-v2.wsdl");
        }
        WSDL_LOCATION = url;
    }
